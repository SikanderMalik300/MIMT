		...
		<div class="card-body">
			<div class="container-fluid">
				...
				<form action="" id="manage-user">	
					...
					<input type="hidden" name="balance" value="<?php echo isset($meta['balance']) ? $meta['balance']: 0 ?>">
					...
					<div class="form-group col-6 ">	
						...
						<input type="phone" name="phone" id="phone" class="form-control" value="<?php echo isset($meta['phone']) ? $meta['phone']: '' ?>" autocomplete="off">
		...
		<div class="card-footer">
				<div class="col-md-12">
					<div class="row">
						...
						<a class="btn btn-sm btn-secondary" href="<?php echo base_url ?>/?page=user/list">Cancel</a>
					</div>
				</div>
			</div>
	</div>
